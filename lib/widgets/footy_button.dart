...
/// tapped.
class _FootballButtonBase extends StatefulWidget {
  const _FootballButtonBase({
    required this.child,
    this.onTap,
    this.onLongPress,
  });
  ...
  @override
  _FootballButtonBaseState createState() => _FootballButtonBaseState();
}

class _FootballButtonBaseState extends State<_FootballButtonBase> {
  bool _tapDown = false;
...
///
/// The [FootballButton.raised] builds a button with elevation and a
/// [backgroundColor].
///
/// The [FootballButton.flat] builds a flat button with a transparent background.
///
...
class FootballButton extends StatelessWidget {
  /// A button that appears raised with a shadow.
  ///
  /// Uses the [FootballTheme.foregroundColor] as the [backgroundColor] by default.

  const FootballButton.raised({
    required this.onTap,
    this.onLongPress,
    this.text,
    this.icon,
  ...
  static _FootballButtonBase custom({
  ...
  ///
  /// Uses the [FootballTheme.foregroundColor] if `null`.
  ...
  /// The [elevation] that changes when using a [FootballButton.flat] or
  /// [FootballButton.raised].
  final double elevation;

  /// Determines the material type that the button uses as its background.
  ///
  /// Set to [MaterialType.transparency] for [FootballButton.flat] and
  /// [MaterialType.canvas] for [FootballButton.raised].
