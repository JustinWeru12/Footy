...
class FootballDialog extends StatefulWidget {
  const FootballDialog({
    this.title,
    this.titlePadding,
    this.content,
  ...
  @override
  _FootballDialogState createState() => _FootballDialogState();
}

class _FootballDialogState extends State<FootballDialog> {
...
/// Builds a [FootballButton] as an action for the [FootballDialog].
///
