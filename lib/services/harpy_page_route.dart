...
class FootballPageRoute<T> extends PageRoute<T>
    with FootballRouteTransitionMixin<T> {
  FootballPageRoute({
...
mixin FootballRouteTransitionMixin<T> on PageRoute<T> {
  ...
  bool canTransitionTo(TransitionRoute<dynamic> nextRoute) {
    return nextRoute is FootballRouteTransitionMixin &&
