...
class FootballMessage extends StatefulWidget {
  FootballMessage({
    required this.child,
  }) : super(key: globalKey);
  ...
  static final globalKey = GlobalKey<FootballMessageState>();

  @override
  FootballMessageState createState() => FootballMessageState();
}

class FootballMessageState extends State<FootballMessage> {
