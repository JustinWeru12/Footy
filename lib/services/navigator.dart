...
final footballRouteObserver = RouteObserver<ModalRoute<dynamic>>();

/// The [FootballNavigator] contains the [Navigator] key used by the root
/// [MaterialApp].
///
/// This allows for navigation without access to the [BuildContext].
// TODO: refactor and make use of flutter's navigator 2.0
class FootballNavigator {
